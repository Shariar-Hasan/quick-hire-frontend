    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-1">
                ...
                <Select
                  value=""
                  onValueChange={(v) => {
                    const found = locations.find((l) => l.id.toString() === v)
                    if (found) setValue('location', found.label as string)
                  }}
                >
                  <SelectTrigger className="w-10 shrink-0 px-2" title="Pick from list">
                    <SelectValue  />
                  </SelectTrigger>
                  <SelectContent>
                    {locations.map((l) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Input {...field} placeholder="BDT / USD" />
                )}
              />
            </div>
          </div>
      ...
      <LocationAddEditDialog
        ...
        onSuccess={(item) => {
          ...
          setValue('location', item.label as string)
        }}
      />
    </div>
  )
